...
export default function TournamentFormPage() {
  ...
  const handleSubmit = async formValues => {
    ...
    // Ostateczna poprawka: Poprawne mapowanie pól i tworzenie obiektu 'categories'
const categoriesData = formValues.category && formValues.gender 
  ? [{ category: formValues.category, gender: formValues.gender }] // Zmieniono 'categoryName' na 'category'
  : [];
    ...
    const dataToSend = {
      ...
      participant_limit: formValues.participant_limit ? Number(formValues.participant_limit) : null,
      applicationsOpen: formValues.applicationsOpen,
      isGroupPhase: formValues.isGroupPhase,
