...
export default function AuthSplit({ mode = 'login' }) {
  ...
  return (
    // Dodajemy nowy div-wrapper dla całej strony, który będzie zawierał Breadcrumbs i kontener autoryzacji
    <div className="auth-page-wrapper">
      <Breadcrumbs items={breadcrumbItems} /> {/* Breadcrumbs jest teraz na zewnątrz flex kontenera */}
